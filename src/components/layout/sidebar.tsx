...
import { BarChart3, Clapperboard, CreditCard, Film, LayoutDashboard, MessageSquare, Receipt, Settings, Tags, UserCircle, Users, Shield, Bell, Star, UserSquare } from "lucide-react";
...
const icons: Record<string, React.ReactNode> = {
  ...
  Profile: <UserSquare className="h-5 w-5" />,
};
